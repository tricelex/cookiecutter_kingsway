...
from {{ cookiecutter.project_slug }}.testing_examples.models import Student, School
from {{ cookiecutter.project_slug }}.testing_examples.services.rosters import roster_create
from {{ cookiecutter.project_slug }}.testing_examples.selectors.schools import school_list_school_courses
